    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between breadcrumb-wrapper">
            <div class="breadcrumb-title">
                <h5 class="h5 mb-0 fw-semibold">Konsultasi Teknis Mengenai Rumah</h5>
            </div>
            ...
            <ul class="breadcrumb-nav p-0 mb-0">
                ...
                <li>/</li>
                <li>
                    Konsultasi Teknis Mengenai Rumah
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-6 col-12 column-item">
                ...
                <div class="consult-schedule-container">
                    <div class="consult-schedule-item">
                        <i class="ri-map-pin-2-line"></i>

                        <div class="body">
                            <p class="p-16 mb-0">
                                Dinas Perumahan dan Kawasan Permukiman Provinsi Sumatera Utara Jl. Jenderal Besar A.H. Nasution No.20, Pangkalan Masyhur, Kec. Medan Johor, Kota Medan, Sumatera Utara 20219.
                            </p>
                        </div>
                    </div>
                    <div class="consult-schedule-item">
