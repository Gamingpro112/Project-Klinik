    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between breadcrumb-wrapper">
            <div class="breadcrumb-title">
                <h5 class="h5 mb-0 fw-semibold">Fasilitasi Penyelenggaraan Rumah Negara di Sumatera Utara</h5>
            </div>
            ...
            <ul class="breadcrumb-nav p-0 mb-0">
                ...
                <li>/</li>
                <li>
                    Fasilitasi Penyelenggaraan Rumah Negara di Sumatera Utara
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-6 col-12 column-item">
                ...
                <p class="p-16 mb-0">
                    Berdasarkan Peraturan Pemerintah Nomor 40 Tahun 1994, Rumah Negara adalah bangunan yang dimiliki negara dan berfungsi sebagai tempat tinggal atau hunian dan sarana pembinaan keluarga serta menunjang pelaksanaan tugas pejabat dan/atau Pegawai Negeri
                </p>
            </div>
        </div>
    </div>
