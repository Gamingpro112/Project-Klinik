    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between breadcrumb-wrapper">
            <div class="breadcrumb-title">
                <h5 class="h5 mb-0 fw-semibold">Artikel</h5>
            </div>
...
{{-- Artikel --}}
<section id="artikel-section" class="mb-56">
    <div class="container-fluid">
        {{-- Program Bantuan --}}
        <div class="row justify-content-sm-center">
            <div class="col-lg-4 col-md-6 col-12 artikel-item">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        <h4 class="h4 color-dark article-title fw-semibold">Jabar Sumbang 186.822 Unit Program Sejuta Rumah</h4>

                        <p class="p-16 mb-3">
                            BANDUNG? Pemerintah Provinsi Jawa Barat akan berupaya mendorong para pengembang dan institusi keuangan untuk terus dapat melaksanakan pembangunan perumahan bersubsidi di wilayah Jawa Barat.
                        </p>
